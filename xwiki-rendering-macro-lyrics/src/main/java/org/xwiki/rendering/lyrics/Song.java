            ...
            do {
                try {
                    if (0 != line.length()) { // skip empty lines
                        ...
                        } else if ((token.equals("newpage")) || (token.equals("np"))
                            || (token.startsWith("newpag") || (token.startsWith("new_pag")))) {
                        ...
                        } else if ((token.equals("breakline")) || (token.equals("colb"))
            ...
            if (fretPos == 1) {
                ...
                if (chord == null) {
                    ...
                    if (showMissingChordsOnSpecificFret) {
                        System.out.println("Kein Akkord " + chordFamily.getFamilyName() + " auf Bund " + fretPos
                            + " (Capo: " + capo + ") gefunden in Lied " + title + "!");
                    }
                }
            }
