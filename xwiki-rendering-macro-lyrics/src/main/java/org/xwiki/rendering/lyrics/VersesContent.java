...
public class VersesContent implements Content
{
    ...
    public String getContent(Parser parser)
    {
                ...
                for (Sequence sequence : sequences) {
                    if (!((sequence.getName().trim().equals("")) && (sequence.getVerse().trim().equals("")))) {
                        if (sequence.getName().trim().equals("")) {
                                ...
                                if (family != null) {
                                    ...
                                    if (c != null) {
                                        ...
                                        if (capoChord != null) {
                                            ...
                                            // log.warn("Es wurde kein Akkord für Kapo auf Bund " + capoFret +
                                            // " für Akkord '" + chord.getName() + "' in Lied '" +
                                            // rawTitle+"' gefunden.");
                                        }
                                    }
                                }
                            ...
                            String verse = sequence.getVerse();// sequence.getVerse().trim() + " ";
                            chords.append("|(% class=\"lyrics_chords\" %)" + chord.trim() + " ");
                            verses.append("|(% class=\"lyrics_verses\" %)" + verse);
                        }
                    }
                }
        ...
        // // } else {
        // //// log.warn("Es wurde kein Akkord für Kapo auf Bund " + capoFret + " für Akkord '" + chord.getName() +
        // "' in Lied '" + rawTitle+"' gefunden.");
        // // }
        // // }
        // // }
        // // }
